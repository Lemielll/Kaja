...
- `type`, `title`, `status`, `detail`, dan `instance` wajib ada.
- Field kustom seperti `conflictingRentalId` dan `unavailableDates` bersifat opsional dan dapat ditambahkan sesuai skenario error.
