...
Write-Host "  [OK] web-app uses exact redirect URIs (no wildcards)"
Write-Host "  [OK] Direct Grant disabled on production client"
Write-Host "  [OK] test-cli only for automated testing"
Write-Host ""
